...
$ttlPrice.textContent = (totalPriceItem + $ttlPriceDelivery.textContent);

$ttlPriceList.forEach(paymentList);
$btnCheckout.textContent = `${$ttlPrice.textContent} 결제하기`;
